            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="POST" action="/transaksi/store">
                        @csrf
                        <div class="card-body">
                            <button type="button" class="btn-sm btn-primary" data-target="#modalCreate" data-toggle="modal"><i class="fa fa-plus"></i> Tambah data</button>
                            <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="kembalian" readonly required>
                                </div>
                            </div>
